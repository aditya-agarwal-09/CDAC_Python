...
You are developing a stateful balance ledger tracker that tracks account state history.
 To satisfy strict architecture requirements, you must manage this state without defining any classes (class keyword is prohibited)
 Instead, you must use closures, nested functions, and Python scoping variables.
